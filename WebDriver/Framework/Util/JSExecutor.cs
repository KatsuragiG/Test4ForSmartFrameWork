...
namespace WebdriverFramework.Framework.Util
{
    ...
    public class JsExecutor : BaseEntity
    {
        ...
        public void ExecuteJs(string jScript, string logInfo)
        {
        ...
        public object ReturnExecutesJsResult(string jScript, string logInfo)
        {
            Logger.Instance.Info(logInfo);
        ...
        /// </summary>
        public void AcceptAlertsOnThePage()
        {
